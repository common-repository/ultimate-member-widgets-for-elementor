...
function user_elementor_dismissible_notice() {
    if ( ! get_user_meta( get_current_user_id(), 'user_elementor_notice_dismissed', false ) ) {
        ...
        <div class="notice notice-info is-dismissible um-elemetor-pro">
            <div class="pro-notice-container">
                <div class="pro-notice-container-left">
                    <button type="button" class="notice-dismiss" onclick="dismissNotice();">
                        <span class="screen-reader-text"><?php _e( 'Dismiss this notice', 'um-elementor' ); ?></span>
                    </button>                      
                    <h4><?php _e( 'WP User Data', 'um-elementor' ); ?></h4>
                    <p><?php _e( 'All Your Ultimate Member User Data in One Place. Grab up to an exclusive $25 OFF', 'um-elementor' ) ?></p>
                </div>

                <div class="pro-notice-container-right">
                    <a href="https://www.userelements.com/wp-user-data/" class="button button-primary" target="_blank">
                        <?php _e( 'Get User Data', 'um-elementor' ) ?>
                    </a>
        ...
        <style type="text/css">
            .um-elemetor-pro{background-color:#fff;border-left-color:#418af7}.um-elemetor-pro .button-primary{background-color:#f5af00!important;border:none!important;color:#333!important;font-weight:600}.um-elemetor-pro ul{list-style:disc;margin-left:1rem}.pro-notice-container-left h4{font-size:18px;font-weight:700;color:#418af7;padding:.25rem 0;margin:.25rem 0}.pro-notice-container-left p{font-size:14px;color:#7b7b7b;margin-top:0}.notice.notice-info.is-dismissible.um-elemetor-pro{padding:1rem}
        </style>
        <?php
    }
}
